#!/usr/bin/env bash
# ==============================================================================
# Build & Flash Loader Script — Phase 13
...
#           with ../../Phase_12/build_payload.sh (hello-world) or ../../Phase_12/build_micropython.sh
#           (MicroPython), copy the signed file to a FAT32 SD card root, then
#           run this script. The loader mounts the SD card at boot, reads +
#           verifies the bundle, unmounts, and executes from PSRAM. This script
#           only builds and flashes the loader artifacts (bootloader, partition
#           table, loader app) — it is payload-agnostic, so one script serves
#           both the hello-world and MicroPython payloads.
# ==============================================================================
set -uo pipefail
