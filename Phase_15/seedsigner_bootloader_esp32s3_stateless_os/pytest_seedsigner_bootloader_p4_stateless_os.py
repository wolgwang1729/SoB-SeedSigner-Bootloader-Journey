...
#
# Matches the Phase 12/13 boot chain in main/main.c:
...
#   3. Phase 13 anti-phishing proof: SHA-256 over the ~6.8 MB random_fill
...
#     (build it with ../../Phase_12/build_payload.sh and copy it to the card)
#
...
def test_stateless_bootloader_and_payload(app: IdfApp, dut: IdfDut) -> None:
    ...
    Validates SD-card load + Specter multisig verification + the Phase 13
    ...
    # ====================================================================
    logging.info('Phase 3: Anti-phishing proof (Phase 13)...')
