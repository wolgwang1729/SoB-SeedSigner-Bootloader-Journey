#!/usr/bin/env bash
# ==============================================================================
# Build & Flash Loader Script — Phase 15
# Target  : ESP32-S3 Stateless Secure Loader (ESP32-S3-DEV-KIT-N8R8)
# Payload : Specter-signed firmware bundle read from the SD card
#           (/sdcard/seedsigner_esp32s3.bin). Build + sign the payload first
#           with ../../Phase_15/build_payload.sh (hello-world shim), copy the
#           signed file to a FAT32 SD card root, then run this script. The loader
#           mounts the SD card at boot, reads + verifies the bundle, unmounts,
#           and executes from PSRAM. This script only builds and flashes the
#           loader artifacts (bootloader, partition table, loader app) — it is
#           payload-agnostic.
# ==============================================================================
set -uo pipefail
