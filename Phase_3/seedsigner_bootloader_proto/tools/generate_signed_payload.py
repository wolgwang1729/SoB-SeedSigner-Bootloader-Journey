...
with open("../plain_hello_world/build/hello_world.bin", 'rb') as f:
    payload = f.read()

attrs = pack_attribute(4, "seedsigner_esp32s3") + pack_attribute(1, "secp256k1-sha256")
...
with open("dummy_fat_dir/seed.bin", 'wb') as f:
    f.write(main_section)
    f.write(sig_section)
print("Signed seed.bin successfully!")
