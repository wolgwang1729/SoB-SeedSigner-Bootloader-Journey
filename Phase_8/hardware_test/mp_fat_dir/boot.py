...
print("=========================================")
print("  SEEDSIGNER SECURE BOOTLOADER VERIFIED  ")
print("=========================================")

try:
    spi = machine.SPI(1, baudrate=40000000, polarity=0, phase=0, sck=machine.Pin(14), mosi=machine.Pin(13), miso=machine.Pin(12))
...
sys.exit(0) # Prevent further errors
